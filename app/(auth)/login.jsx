import { ActivityIndicator, Keyboard, StyleSheet, Text, TouchableWithoutFeedback, View, TouchableOpacity, Alert } from 'react-native'
        ...
        if (sessionKeys.length > 0) {
          ...
          for (const mpinKey of mpinKeys) {
            ...
            if (mpinData) {
              ...
              const lastLogin = new Date(parsed.lastLogin || parsed.createdAt || 0).getTime()
  ...
  useEffect(() => {
    const checkStoredSession = async () => {
      if (email.trim() && email.includes('@')) {
        ...
        const hasSecureSession = await SecureStorage.hasStoredSession(email.trim())
        const localMpinData = await AsyncStorage.getItem(`user_mpin_${email.trim()}`)
      ...
      <ThemedView style={styles.container} safe={true}>
        ...
        {quickAccessEmail && loginMethod === 'mpin' ? (
          ...
          <View style={styles.quickAccessSection}>
            ...
            <ThemedButton onPress={handleMpinLogin} style={styles.quickAccessButton}>
          ...
          <>
            ...
            {loginMethod === 'email' ? (
              ...
              <View style={styles.mpinSection}>
                ...
                <ThemedButton onPress={handleMpinLogin} disabled={!email.trim()}>
