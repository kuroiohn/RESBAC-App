...
const ChangeMpinModal = ({ visible, onClose }) => {
  ...
  const handleChangeMpin = async () => {
    ...
    try {
      ...
      Alert.alert("Success", "Your MPIN has been changed successfully!", [
        {
          text: "OK",
          onPress: () => {
            resetForm();
      ...
      Alert.alert(
        "Error",
        error.message || "Failed to change MPIN. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.progressContainer}>
            <View
              style={[
                styles.progressDot,
                step >= 1 && styles.progressDotComplete,
              ]}
            />
          ...
          <View style={styles.requirementsContainer}>
            ...
            <Text style={styles.requirementText}>
              • Must be different from current MPIN
            </Text>
          </View>
        </View>
      </View>
